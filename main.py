...
async def on_ready():
    ...
    activity_status = random.choice(("週末京都現実逃避", "2:23 AM", "SUMMER TRIANGLE", "You and Me", "10℃"))
    await bot.change_presence(activity=discord.Game(name=f"/help｜Join server {len(bot.guilds)}｜Listening {activity_status}"))
    try:
